<template>
    <section class="relative w-full" data-aos="zoom-in-up">
        <div class="absolute top-0 inset-x-0 h-64 flex items-start">
            <div class="h-24 w-2/3 bg-gradient-to-br from-[#570cac] to-bgcolor blur-2xl invisible opacity-40"></div>
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                ...
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-[50px] shadow-lg border border-primary">
                            <img src="@/assets/Evander.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                            ...
                            <!-- <button class="px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                                <span class="absolute inset-0 rounded-3xl group-hover:scale-105 origin-center 
                                transition-all ease-in-out bg-primary border-2 border-transparent">
                            ...
                            <button class=" border border-[#F59E0B] px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                                ...
                                <a :href="resume" download="evander resume.pdf" class="pl-2 text-[#F59E0B]"> Download resume</a>
                                </div>
                            </button>
...
<script setup>
import resume from '@/assets/EvanderNikolai-CV.pdf';
import AOS from 'aos';
